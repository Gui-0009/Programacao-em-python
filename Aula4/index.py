...
print('A concatenação desses números como strings é:', n1 + n2)
...
frase = "Paulo foi ao mercad"
continuacao = input("Digite o que o Paulo fez no mercado")
print(frase + "o " + continuacao)
